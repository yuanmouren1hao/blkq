...
<form method="post" class="form-x">
  ...
  <div class="form-group">
    ...
    <div class="field">
      <input type="text" class="input" id="title" name="title" size="50" placeholder="请在这里输入标题~" data-validate="required:请填写~" />
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="field">
        <input  data-validate="required:请填写~" type="text" class="input"  name="author" id="author" value="<?php echo session('user.user_name')?>" size="50" />
    </div>
  	</div>
