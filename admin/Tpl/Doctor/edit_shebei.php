...
<form method="post" class="form-x" action="<?php echo U('Doctor/edit_shebei');?>">

  
  <div class="form-group">
		<div class="label">
			<label for="readme">设备类别</label>
		</div>
		<div class="field">
			<select class="input" name="catelog_id" id="catelog_id">
				...
				<option value='{$info.catelog_id}' selected="selected">{$info.child}</option>
			</select>
		</div>
	</div>
  ...
  <div class="form-group">
    <div class="label"><label for="readme">设备简介</label></div>
    <div class="field">
      <textarea class="input" rows="5" cols="50" name="desc"  placeholder="在这里输入简介~">{$info.desc}</textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="field">
      <textarea class="input" rows="5" cols="50" name="content"  placeholder="在这里输入详情~">{$info.content}</textarea>
    </div>
  </div>
