			...
			<div class="xs6 xm4 xs3-move xm4-move">
				...
				<div class="media media-y">
					<a href="<?php echo mc_option("site_url")?>" target="_blank"><img
						src="<?php echo mc_option('logo');?>" class="radius" alt="后台管理系统" />
					</a>
				</div>
				<br /> <br />
				...
				<form action="<?php echo U('doctor/login');?>" method="post">
					<div class="panel">
						<div class="panel-head">
							登录 <strong> <?php echo mc_option('site_name'); ?> </strong>
							医师预约系统
						</div>
						<div class="panel-body" style="padding: 30px;">
							...
							<div class="form-group">
								<div class="field">
									<input type="text" class="input" name="verify"
										placeholder="填写右侧的验证码" data-validate="required:请填写右侧的验证码" /> <img
										src="<?php echo U("index/verify");?>" width="80" height="32"
										class="passcode" />
								</div>
							</div>
						</div>
						<input type='hidden' name='tag' value='tag' />
						<div class="panel-foot text-left">
							<button class="button button-block bg-main text-big">立即登录后台</button>
							<span><a class="tag bg-blue-light" href="{:U('doctor/yuanzhang_login')}">院长登陆 >></a> </span>
						</div>
