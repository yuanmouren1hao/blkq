...
<head>
    ...
    <title><?php echo mc_option('site_name')?>-院长</title>
...
<div class="container">
    <div class="line">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="<?php echo U('doctor/yuanzhang_login');?>" method="post">
            <div class="panel">
                <div class="panel-head">登录 <strong> <?php echo mc_option('site_name'); ?></strong> 院长查看系统</div>
