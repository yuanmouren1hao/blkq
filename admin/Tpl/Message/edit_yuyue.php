...
<input type="hidden" name="id" value="{$info.id}" />
	...
	<div class="form-group">
		...
		<div class="field">
			<input type="text" class="input input-auto" disabled="disabled" value="{$info.id}" size="20"  />
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="field">
			<input type="text" class="input input-auto" name="name"  value="{$info.name}" size="20"  />
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="field">
			<input type="text" class="input input-auto" disabled="disabled" value="{$info.age}" size="20"  />
		</div>
	</div>
    <div class="form-group">
		<div class="label">
		...
		<div class="field">
			<input type="text" class="input input-auto" disabled="disabled" value="{$info.sex}" size="20"  />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="field">
			<input type="text" class="input input-auto" name="tel" value="{$info.tel}" size="20"  />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="field">
        	<input class='input input-auto' size="20" id='txtTm' onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name='order_time' value="{$info.order_time}"  />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="field">
			<input type="text" class="input input-auto" name="order_time2" value="{$info.order_time2}" size="10"  />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="field">
			<input type="text" class="input input-auto" disabled="disabled" value="{$info.ip}" size=20 />
		</div>
	</div>
