...
<body>
	<form action="{:U('user/edit')}" method="post" name="form" id="form">
		<input type="hidden" name="tag" value="eidtuser">
		...
		<div class="creatbox">
			<div class="middle">
				...
				<div class="input-label">
					<label class="label-text">用户名：</label> {$info.name}
				</div>
				<div class="input-label">
					<label class="label-text">用户密码：</label>
					<div class="label-box">
						<input type="text" name="val_password"><span class="txt">（如果无需修改则不填）</span>
					</div>
				</div>
				<div class="input-label">
					<label class="label-text">用户电话：</label>
					<div class="label-box">
						<input type="text" name="val_tel" value="{$info.tel}">
					</div>
				</div>
				<div class="input-label">
					<label class="label-text">用户微信：</label>
					<div class="label-box">
						<input type="text" name="val_weixinid" value="{$info.weixin_id}">
					</div>
				</div>
				...
				<div class="input-label">
					...
					<div class="label-box">
						<input type="text" name="val_email" value="{$info.mail}">
					</div>
				</div>
				...
				<div
					...
					<div class="label-box form-inline">
						<volist name="permissionlist" id="vo">
							<label class="checkbox" style="margin-right: 10px">
								<input type="checkbox" name="val_permission_id" value="{$vo.tbid}" <?php if($vo['tbid']==$info['permission_id']):?> checked<?php endif;?>>
								{$vo.name}
							</label>
						</volist>
