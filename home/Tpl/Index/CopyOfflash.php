	...
	<div id="box">
		<ul id="pic_list">
			...
			<li <?php if($i==1):?>
				...
				<?php endif;?>><a
				href="<?php echo U("index/news_detail");?>?id={$vo.id}"><img
					width="780" height="330" src="{$vo.fmimg_b}" alt="{$vo.title}" /></a></li>
			</volist>
		</ul>
		...
		<ul id="text_list">
			...
			<li <?php if($i==1):?> class="show" <?php endif;?>><h2>
					<a target="_parent"
						href="<?php echo U("index/news_detail");?>?id={$vo.id}">{$vo.title}-<?php echo $i?></a>
				</h2></li>
			</volist>
		</ul>
